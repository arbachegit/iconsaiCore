...
import s from './skills-mobile.module.css'
...
export default function SkillsMobilePage() {
  ...
  return (
    <div className={s.root}>
        ...
        <>
          ...
          <section className={s.lifecycleSection}>
            ...
            <div className={s.lifecycleDiagram}>
              ...
              {PHASES.map((phase) => {
                const skills = skillsByPhase[phase.number] || []
      ...
      <footer className={s.footer}>
        ...
        <p className={s.footerSub}>Atualizado em 26/02/2026</p>
      </footer>
